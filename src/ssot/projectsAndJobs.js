export const projectsAndJobs = [
	{
		...
		title: 'Autoinspector',
		label: 'Job 1',
		helper: 'November 2021 to November 2022',
		description:
			'With Autoinspector you can inspect everything, when, where and as many times as you need. Digital, automated and real-time inspections, powered by artificial intelligence.',
	...
	},
	{
		...
		codeUrl: 'https://github.com/nicohermida01/futball-league',
	...
	},
	{
		...
		label: 'Project 5',
		description:
			'ScrabbleAR is a videogame where players try to score as many points as possible by forming words on a board.',
		techs: ['Python'],
		codeUrl: 'https://github.com/nicohermida01/ScrabbleAR',
	},
]
